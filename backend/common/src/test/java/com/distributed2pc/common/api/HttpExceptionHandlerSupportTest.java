...
/**
 * Unit tests for {@link HttpExceptionHandlerSupport}.
 */
class HttpExceptionHandlerSupportTest {

    private final HttpExceptionHandlerSupport handler = new HttpExceptionHandlerSupport() {
    };
     ...
     */
    @Test
    void handleTypeMismatch_givenMismatchOnParam_returnsBadRequestWithParamName() {
        MethodArgumentTypeMismatchException ex = mock(MethodArgumentTypeMismatchException.class);
        when(ex.getName()).thenReturn("id");

        Map<String, String> response = handler.handleTypeMismatch(ex);

        assertThat(response).containsEntry("message", "Invalid value for parameter 'id'");
    }
    ...
    void handleMediaTypeNotSupported_givenTextPlain_returnsUnsupportedMediaType() {
        ...
        assertThat(response)
                ...
                .containsEntry("message", "Content type '" + MediaType.TEXT_PLAIN + "' is not supported");
    }
